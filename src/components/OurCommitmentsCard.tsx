...
export default function OurCommitmentsCard(props:any) {
  return (
    <>
      <div className="flex flex-col w-90% p-5 items-start  bg-white rounded-lg shadow-md hover:shadow-lg hover:-mt-2 duration-300 group">
